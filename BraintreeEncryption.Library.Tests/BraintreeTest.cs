...
namespace BraintreeEncryption.Library.Tests
{
    ...
    {
        private const String PublicKey = "MIIBCgKCAQEA8wQ3PXFYuBn9RBtOK3lW4V+7HNjik7FFd0qpPsCVd4KeiIfhuzupSevHUOLjbRSqwvAaZK3/icbBaM7CM"
        ...
        private const String PrivateKey = "MIIEowIBAAKCAQEA8wQ3PXFYuBn9RBtOK3lW4V+7HNjik7FFd0qpPsCVd4KeiIfhuzupSevHUOLjbRSqwvAaZK3/icbB"
        ...
        private const String DataToEncrypt = "test data";
        private Braintree _braintree;
        private String _encryptedPrefix;
        ...
        {
            Assert.AreEqual(PublicKey, _braintree.GetPublicKey());
        }
